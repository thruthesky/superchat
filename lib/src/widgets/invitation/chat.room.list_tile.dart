...
//       children: [
//         // TODO review how to do customizations
...
//         if (join.lastMessageAt != null) Text((join.lastMessageAt!.toString())),
//       ],
//     );
//     if (join.group) {
//       return ListTile(
...
//         title: Text(
//           (join.name ?? "").isNotEmpty ? join.name! : "Group Chat",
//           maxLines: 1,
...
//                   ? Center(
//                       child: Text(
//                         getOtherUserUidFromRoomId(join.roomId)!
//                             .characters
//                             .first
//                             .toUpperCase(),
...
//     if (join.lastMessageUid != null &&
//         UserService.instance.blocks.containsKey(join.lastMessageUid)) {
//       return Text(
